                    ...
                    <main className="flex-grow md:px-16 px-8 pt-[7rem]">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <ul className="space-y-8 mb-6">
                                ...
                                <li className="dark:bg-gray-800 bg-gray-200 p-4 rounded-2xl border-2 dark:border-white/20 border-gray-500/20">
                                    <h4 className="text-xl font-bold dark:text-blue-400 text-blue-500">Scalable Architecture</h4>
                                    ...
                                    <ul className="mt-3 space-y-2 list-disc list-inside dark:text-gray-300 text-gray-900">
                                        <li><span className="dark:text-blue-400 text-blue-500 font-medium">Handles massive traffic spikes</span> without degrading performance.</li>
                                        <li><span className="dark:text-blue-400 text-blue-500 font-medium">Load balancing</span> ensures stability even during peak usage.</li>
                                        <li><span className="dark:text-blue-400 text-blue-500 font-medium">Optimized connection management</span> prevents resource exhaustion.</li>
                                    </ul>
                                </li>
                                ...
                                <li className="dark:bg-gray-800 bg-gray-200 p-4 rounded-2xl border-2 dark:border-white/20 border-gray-500/20">
                                    ...
                                    <ul className="mt-3 space-y-2 list-disc list-inside dark:text-gray-300 text-gray-900">
                                        <li>🚀 <span className="dark:text-indigo-400 text-indigo-500 font-medium">Pure WebSocket Solution</span> – No client-side SDKs required.</li>
