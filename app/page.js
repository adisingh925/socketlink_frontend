      ...
      <div className="flex flex-col h-[100dvh] dark:bg-gray-900">
        ...
        <div className="flex items-center justify-center px-6 py-10 mt-20 flex-grow dark:bg-gray-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {/* Existing Cards */}
            <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-center text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-gray-900 mb-2">Real-time Chat</h3>
            ...
            <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-center text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-gray-900 mb-2">Secure Connections</h3>
            ...
            <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-center text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-gray-900 mb-2">Live Streaming</h3>
            ...
            <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-center text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-gray-900 mb-2">Collaborative Editing</h3>
            ...
            <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-center text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-gray-900 mb-2">Gaming</h3>
            ...
            <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-center text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-gray-900 mb-2">Stock Market Feeds</h3>
            ...
            <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-center text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-gray-900 mb-2">IoT Communication</h3>
            ...
            <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-center text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
              ...
              <h3 className="text-xl font-semibold dark:text-white text-gray-900 mb-2">Sports Updates</h3>
