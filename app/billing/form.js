            ...
            <>
                <div className="flex flex-col h-[100dvh] dark:bg-gray-900">
                    ...
                    <div className="flex items-center justify-center px-6 py-10 mt-20 flex-grow dark:bg-gray-900">
                        <div className="w-full max-w-lg p-4 sm:p-8 dark:bg-gray-800 bg-gray-200 text-white rounded-2xl shadow-xl border-2 dark:border-white/20 border-gray-500/20">
